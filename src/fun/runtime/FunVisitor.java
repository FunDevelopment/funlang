/* Fun
 *
 * $Id: FunVisitor.java,v 1.22 2015/04/20 12:50:41 sthippo Exp $
 *
...
/** Base class of fun tree visitors.  Implements FunParserVisitor, a
 *  jjtree-generated interface implementing the Visitor design pattern.
 *  Subclasses of FunVisitor may override the handleNode method for general
 ...
 */
abstract public class FunVisitor implements FunParserVisitor {
     ...
     *  primitive.
     */
    protected Object handleNode(FunNode node, Object data) {
        //if (!node.isPrimitive()) {
    ...
    /** Needed to satisfy the FunParserVisitor interface; should never
     *  be called.
     */
     ...
     *  be called.
     */
    public Object visit(FunNode node, Object data) {
