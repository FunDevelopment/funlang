 ...
 *
 * Copyright (c) 2008-2015 by fundev.org
 *
...
/**
 * Class for executing OS commands from Fun.
 *
...
public class Exec {
    ...
    public static Exec execFactory(String command, Object envObj, Object dirObj) {
        ...
        } else if (dirObj instanceof FunFile) {
            return new Exec(command, (Map<String, String>) envObj, (FunFile) dirObj);
    ...
    public Exec(String command, Map<String, String> env, FunFile dir) {
