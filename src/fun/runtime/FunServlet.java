/* Fun
 *
 * $Id: FunServlet.java,v 1.37 2014/11/01 19:49:43 sthippo Exp $
 *
...
public class FunServlet extends FunServer {
    ...
    protected void respond(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        if (site == null || exception != null) {
            out.println("<head><title>Fun Error</title></head>");
            out.println("<body BGCOLOR=\"#88ccbb\">");
            if (site == null) {
                out.println("<h2>Unable to load Fun site</h2>");
                if (exception != null) {
                ...
                out.println("<p>Fun site: " + site.getName() + "</p>");
    ...
    private void respondWithFile(File file, FunSite site, HttpServletResponse response) throws ServletException, IOException {
