...
import fun.lang.CollectionDefinition;
...
/**
 *  An external runtime utility class for operations on Fun arrays.
 * 
 *  @author mash
 *
 */
...
public class Array {
    ...
    public static Object parse(Context context, String str) throws ParseException, Redirection {
        try {
            ...
            FunArray array = collectionDef.getArray(context, null, null);
            if (array != null) {
