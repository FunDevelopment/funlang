...
public class Logger implements FunParserVisitor {
    ...
    public static String getDescription(AbstractNode node) {
        ...
        if (node instanceof Type) {
            ...
            FunNode reference = ((Instantiation) node).getReference();
            ...
            desc = "CONSTRUCTION";
        } else if (node instanceof FunStatement) {
            desc = "STATEMENT";
    ...
    private void logNodeInfo(FunNode funNode) {
    	AbstractNode node = (AbstractNode) funNode;
    ...
    public Object visit(ParsedConcurrentFunBlock node, Object data) {
        logIfVerbose("ConcurrentFunBlock:");
        return handleNode(node, data);
    }
