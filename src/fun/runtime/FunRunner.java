...
public class FunRunner implements fun_processor {
    public static final String NAME = "FunRunner";
    ...
    public static void main(String[] args) {
        ...
        if (noProblems) {
            FunRunner runner = new FunRunner(initParams);
    ...
    /** Constructor */
    public FunRunner(Map<String, String> initParams) {
