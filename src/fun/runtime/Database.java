...
/**
 * Supports basic database access by Fun code.
 *
...
//                        table = new HashMap((Map) contents);
    ...
    public FunArray query(String sql, Object[] fields) throws Redirection {
        try {
    ...
    public FunArray query(String sql) throws Redirection {
        try {
    ...
    public FunArray query(String sql, String count_sql) throws Redirection {
        try {
