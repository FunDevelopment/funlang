...
import fun.parser.ParsedStringLiteral;
import fun.runtime.Context;
import fun.runtime.Logger;
...
public class AnonymousDefinition extends FunStatement implements Definition {
    ...
    // methods defined by Fun definition  
    ...
    public List<Object> instantiate_array(fun_context context) throws Redirection {
    ...
    public Map<String, Object> instantiate_table(fun_context context) throws Redirection {
    ...
    /** Construct this definition without arguments in the specified fun_context, 
     *  which is available to fun code via the runtime reflection api.
     */
     ...
     *  is the Fun supertype of the external object.
     **/
            ...
            if (childDef == null) {
                if (type != null && type.getName().equals("definition")) {
                    ...
                    if (cName.equals("defs") || cName.equals("descendants_of_type") || cName.equals("full_name")) {
                        ExternalDefinition externalDef = new ExternalDefinition("fun.lang.AnonymousDefinition", getParent(), getOwner(), type, getAccess(), DYNAMIC, this, null);
