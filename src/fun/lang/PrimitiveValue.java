...
//        }
    ...
    public static String getStringFor(Object value) {
        if (value == null) {
        ...
        } else if (value instanceof Object[] || value instanceof Collection<?> || value instanceof FunArray) {
            
            if (value instanceof FunArray) {
                value = ((FunArray) value).getArrayObject();
                if (value == null) {
                    return "";
                }
            }
            ...
            return (str == null ? "" : str);
        } else if (value instanceof FunObjectWrapper) {
            String str = "";
            try {
                str = ((FunObjectWrapper) value).getText();
            } catch (Redirection r) {
                ;
            }
            return (str == null ? "" : str);
    ...
    public static boolean getBooleanFor(Object value) {
        if (value == null) {
            ...
            return (((FunObjectWrapper) value).getConstruction() != null);
        } else {
            try {
