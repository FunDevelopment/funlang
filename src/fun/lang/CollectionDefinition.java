...
public class CollectionDefinition extends ComplexDefinition /* implements DynamicObject */ {
    ...
    public boolean isHonestCollection() {
        return (!isAlias() && !isParamAlias() && !(getContents() instanceof FunBlock)); 
    }
...
//        } else if (collection instanceof FunArray) {
//            return ((FunArray) collection).instantiateArray(context);
    ...
    private static Object getUnresolvedObjectValue(Context context, Object element) {
        //if (!(element instanceof ResolvedInstance) && !(element instanceof FunObjectWrapper)) {
