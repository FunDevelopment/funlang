...
public class ArrayBuilder extends CollectionBuilder {
    ...
    public FunArray getArray(Context context, ArgumentList args, List<Index> indexes) throws Redirection {
...
class FixedArray implements FunArray {
...
class GrowableArray implements FunArray {
...
class ArrayInstance implements FunArray, DynamicObject {
    private ValueGenerator valueGen;
    private FunArray array = null;
    ...
    private void init_array() {
        if (data == null) {
            ...
            if (data instanceof FunObjectWrapper) {
                try {
                    obj = ((FunObjectWrapper) data).getData();
                } catch (Redirection r) {
...
class DynamicArray implements FunArray, DynamicObject {
    private FunArray statements;
    private Context initContext;
    private transient List<Object> generatedArray = null;


    public DynamicArray(FunArray statements) {
        this.statements = statements;
    }

    public DynamicArray(FunArray statements, Context context) throws Redirection {
        this.statements = statements;
        initContext = (Context) context.clone();
