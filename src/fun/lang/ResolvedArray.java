 ...
 * ResolvedArray.java
 *
 * Copyright (c) 2015-2017 by fundev.org
 *
...
class ResolvedArray extends ResolvedCollection {
    ...
    public ResolvedArray(Definition def, Context context, ArgumentList args, List<Index> indexes) throws Redirection {
        ...
        if (collectionDef.hasStaticData()) {
            array = (FunArray) collectionDef.getStaticData();
        } else {
    ...
    public ResolvedArray(Definition def, Context context, ArgumentList args, List<Index> indexes, Object arrayData) throws Redirection {
    	...
    	if (arrayData instanceof FunArray) {
            array = (FunArray) arrayData;
     ...
     */
    private static FunArray createArray(Definition def, Context context, ArgumentList args) throws Redirection {
    ...
    private static FunArray allocate(boolean fixed, int size) {
        if (fixed) {
