...
abstract public class ArithmeticOperator extends BinaryOperator {
    ...
    public Value operate(ValueSource firstObj, ValueSource secondObj, Context context) throws Redirection {
        ...
        if ((type1 != null && type1.isArray()) || (type2 != null && type2.isArray())) {
            ...
            if (type1 != null && type1.isArray()) {
                ...
                obj1 = val.getValue();
                if (obj1 instanceof FunArray) {
                    obj1 = ((FunArray) obj1).getArrayObject();
                }
                if (obj1 == null) {
                    obj1 = new Object[0];
                }
            ...
            if (type2 != null && type2.isArray()) {
                ...
                obj2 = val.getValue();
                if (obj2 instanceof FunArray) {
                    obj2 = ((FunArray) obj2).getArrayObject();
                }
                if (obj2 == null) {
                    obj2 = new Object[0];
                }
    ...
    public Value operate(Value firstVal, Value secondVal) {
        ...
        if (firstObj instanceof FunArray) {
            firstObj = ((FunArray) firstObj).getArrayObject();
        }

        Object secondObj = secondVal.getValue();
        if (secondObj instanceof FunArray) {
            secondObj = ((FunArray) secondObj).getArrayObject();
        }
