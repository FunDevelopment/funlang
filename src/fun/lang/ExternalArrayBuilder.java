...
abstract class FunArrayAdapter implements FunArray {

    private FunArray array;

    public FunArrayAdapter() {}

    protected void setArray(FunArray array) {
        this.array = array;
    }

    public FunArray getArray() {
        return array;
    }
...
class MethodArrayDefinition extends FunArrayAdapter {
        ...
        if (array == null) {
            ...
            try {
                ...
                if (object != null) {
                    ...
                    } else if (object instanceof FunArray) {
                    	setArray((FunArray) object);
                    } else {
...
class FieldArrayDefinition extends FunArrayAdapter {
    private Object instance;
    private Field field;
...
class ExternalFixedArray implements FunArray {
...
class ExternalGrowableArray implements FunArray {
