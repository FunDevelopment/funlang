...
/**
 * A DynamicElementBlock is a FunBlock which supports the ConstructionGenerator interface.
 * DynamicElementBlocks are used in Fun constructs such as collection comprehensions.
 *
 * @author Michael St. Hippolyte
 * @version $Revision: 1.16 $
 */

public class DynamicElementBlock extends DynamicFunBlock implements ConstructionGenerator {

    public DynamicElementBlock() {
        super();
    }
    
    protected DynamicElementBlock(DynamicFunBlock proto, Context context) {
        super(proto, context);
    }
...
//            }
//            
//            Block block = new FunBlock(nodes);
