...
public class ComplexName extends NameNode implements Name, Initializable {
    ...
    private void parseName(String name) {
        try {
            FunParser parser = new FunParser(new StringReader(name));
    ...
    private String computeName() {
        String name = null;
        Iterator<FunNode> it = getChildren();
        FunNode node = null;
        while (it.hasNext()) {
            node = it.next();
...
//            } else 
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ComplexName || obj instanceof ComplexType) {
            Iterator<FunNode> it = getChildren();
            Iterator<FunNode> otherIt = ((FunNode) obj).getChildren();

            FunNode node = null;
            FunNode otherNode = null;
