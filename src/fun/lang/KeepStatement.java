...
import fun.runtime.Context.Entry;

/**
 * KeepStatement represents a statement with a cache prefix, which provides caching 
 * strategy hints to the fun processor.
 *
 * @author Michael St. Hippolyte
 * @version $Revision: 1.27 $
 */
public class KeepStatement extends FunStatement {
...
//        }        
    ...
    protected void setAsNameGenerator(FunNode node) {
