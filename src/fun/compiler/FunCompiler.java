/* Fun
 *
 * $Id: FunCompiler.java,v 1.14 2015/06/15 13:18:24 sthippo Exp $
...
public class FunCompiler {
    ...
    public static void main( String args[] ) {
        if ( args.length == 0 ) {
            ...
            FunCompiler bc = new FunCompiler();
            bc.compile( args );
        }
    }
    ...
    private static void showHelp() {
        System.out.println( "\nUsage:\n        java func [options] sourcepath[:sourcepath...] [pagename]" );
        //System.out.println( "\n   or:\n        java -jar fun.jar [options] sourcepath[:sourcepath...]" );
        ...
        System.out.println( "               files that match the filter (default: *.fun)" );
    ...
    void compile( String args[] ) {
        ...
        SiteLoader loader = new SiteLoader(core, "", funPath, inFilter, recursive, options);
        loader.load();
