...
core {
    ...
    dynamic replace_all(str, strmap{}), (str, regex, replacement) = (strmap ?? fun.runtime.Utils.replaceAllOccurrences(str, strmap) : fun.runtime.Utils.replaceAll(str, regex, replacement)) 
