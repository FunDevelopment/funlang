/* Fun Test Suite: ExternalTest.java
 *
...
/** ExternalTest is designed to help the Fun test suite (test.fun) test
 *  the external object interface in a Fun implementation.  Tests include
